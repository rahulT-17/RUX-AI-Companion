### RUX - AI Companion Backend 

## Project Overview :
- This is a Backend AI - companion made by using FAST-API , has a local memory (used for prototyping) and is integrated with a Local LM via LM studio (model-Qwen v3 4B). 

## GOAL :
- My goal with this project is to bulid while learning how AI is being develop and how it can be integrated in an app.
...
- 2. Memory : I have included a local memory state for the AI to access , I have used this for remembering the name provided by the user and to greet , this makes the prototype to be more alive.
...
# Core Language :
- **Python** - used for all the backend logic , memory handling and AI integration.
